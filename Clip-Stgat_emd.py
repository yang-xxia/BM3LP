...
clip_model = CLIPModel.from_pretrained("./BM3LP/clip-vit-base-patch16")
processor = CLIPProcessor.from_pretrained("./BM3LP/clip-vit-base-patch16")

device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
clip_model.to(device)

description_file = './BM3LP/dataset/BriM/entity_description.txt'
descriptions = pd.read_csv(description_file, sep='\t', header=None, names=['id', 'description'])

image_dir = './BM3LP/dataset/BriM/entity_image'
...
with open('./BM3LP/dataset/BriM/image_embeddings_stc_domain_pre.pkl', 'wb') as f:
    pickle.dump(image_embeddings, f)

with open('./BM3LP/dataset/BriM/text_embeddings_stc_domain_pre.pkl', 'wb') as f:
